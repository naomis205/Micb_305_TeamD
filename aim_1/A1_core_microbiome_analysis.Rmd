...
```{r Core Microbiome Analysis}

# Subset phyloseq object for HNDR and HLI groups
ps_HNDR <- subset_samples(ps_relab_genus, is.na(diet_special_needs))
ps_HLI <- subset_samples(ps_relab_genus, diet_special_needs == "diet_lactose_intolerance")
